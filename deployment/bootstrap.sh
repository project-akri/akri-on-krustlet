# This scrips belongs to the Krustlet project and is a copy of what can be found
# here: https://github.com/deislabs/krustlet/blob/main/docs/howto/assets/bootstrap.sh
#!/usr/bin/env bash
set -euo pipefail
